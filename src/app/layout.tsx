...
import { Footer, Header, RouteGuard, Providers, ScrollToTop, CursorGlow, ProfileClip } from "@/components";
...
export default async function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <link rel="icon" href={person.avatar} type="image/jpeg" />
        <link rel="shortcut icon" href={person.avatar} type="image/jpeg" />
